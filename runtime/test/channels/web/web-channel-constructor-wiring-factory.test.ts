...
import type { WebChannelEndpointFacadeOptions } from "../../../src/channels/web/channel-endpoint-facade-service.js";
...
import type { WebChannelRuntimeStateCallbacks } from "../../../src/channels/web/runtime-state-service.js";
import {
...
} from "../../../src/channels/web/web-channel-constructor-factory.js";
...
describe("web channel constructor wiring factory", () => {
  test("assembles collaborators with shared live identity and runtime wiring", async () => {
    ...
    const remoteInterop = sentinel<ReturnType<WebChannelConstructorFactoryDeps["createRemoteInterop"]>>("remote-interop");
    ...
    const terminalVncHttpService = sentinel<ReturnType<WebChannelConstructorFactoryDeps["createTerminalVncHttpService"]>>("terminal-vnc");
    ...
    expect(result.remoteInterop).toBe(remoteInterop);
    ...
    expect(result.terminalVncHttpService).toBe(terminalVncHttpService);
