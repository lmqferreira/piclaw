import { handleAbort, handleAbortBash, handleAbortRetry, handleAutoCompact, handleAutoRetry, handleCompact, handleRestart, } from "./agent-control/handlers/control.js";
import { handleAgentAvatar, handleAgentName } from "./agent-control/handlers/agent.js";
import { handleCommands, handleContext, handleLast, handleState, handleStats, } from "./agent-control/handlers/info.js";
import { handleCycleModel, handleCycleThinking, handleModel, handleThinking, } from "./agent-control/handlers/model.js";
...
import { handleExportHtml, handleFork, handleForks, handleNewSession, handleSessionName, handleSwitchSession, } from "./agent-control/handlers/session.js";
