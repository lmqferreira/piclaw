...
describe("parsePostPayload", () => {
  ...
  test("accepts content within 100 KB", () => {
...
describe("SSE client cap", () => {
  test("rejects connections when at capacity", () => {
...
// We test the withSecurityHeaders behavior indirectly through the exported functions
describe("security headers", () => {
  test("response contains expected headers", async () => {
    // Import the module to test the handle() wrapper
    // We'll test by checking that known headers are set
    ...
    // Verify the constants exist by checking module imports work
